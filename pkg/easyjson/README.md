# easyjson [![Build Status](https://github.com/cdvelop/vanify/pkg/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/cdvelop/vanify/pkg/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/cdvelop/vanify/pkg/easyjson)](https://goreportcard.com/report/github.com/cdvelop/vanify/pkg/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/cdvelop/vanify/pkg/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/cdvelop/vanify/pkg/easyjson && go install github.com/cdvelop/vanify/pkg/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/cdvelop/vanify/pkg/easyjson)
...
listing](https://godoc.org/github.com/cdvelop/vanify/pkg/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/cdvelop/vanify/pkg/easyjson/buffer)
